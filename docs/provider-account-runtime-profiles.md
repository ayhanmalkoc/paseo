...
| Gemini   | Disabled. Gemini launches through Gemini CLI ACP and uses native Gemini CLI auth/config for now.                                                         | Not enabled.                                                                          | Not enabled. Gemini CLI account/config/session boundaries need provider-specific design before managed account switching is exposed.                                 |
